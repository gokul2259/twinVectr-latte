...
<input class='widefat' id="<?php echo esc_attr( $this->get_field_id('icon') ); ?>" name="<?php echo esc_attr( $this->get_field_name('icon') ); ?> type='text'"> 

		<?php /*	<select class='widefat' id="<?php echo esc_attr( $this->get_field_id('icon') ); ?>" name="<?php echo esc_attr( $this->get_field_name('icon') ); ?>"> 
					...
					<div data-sr="ease-in-out wait 0.25s" class="col-md-4 col-sm-6 text-center service-box">
						...
						<?php if( !empty($instance['icon']) ): ?>
							<div class="service-icon">
								<a <?php if (isset($instance['newwindow'])) : if (1 == $instance['newwindow']) echo 'target="_blank"'; endif ?> <?php if( !empty($instance['link']) ): echo 'href="'.esc_url($instance['link']).'"'; endif; ?>><i class="fa"> <?php //echo esc_html($instance['icon']); 

echo "<img src=".$instance['icon']." style='height:310px; width:400px;'>" ?></i> <h3><?php if( !empty($instance['title']) ): echo esc_html($instance['title']); endif; ?></h3></a>
							</div>
						<?php endif; ?>
